...
public class CheesyCompactingRecipeGen extends CompactingRecipeGen {
    ...
    BLACK_AND_BLUE_STRIDER_CHEESE_WHEEL = create(CheesyItems.BLACK_AND_BLUE_STRIDER_CHEESE_WHEEL::get, b -> {
    ...
    STRIDER_CHEESE_WHEEL = create(CheesyItems.STRIDER_CHEESE_WHEEL::get, b -> {
    ...
    JACK_MIX_CHEESE_WHEEL = create(CheesyItems.JACK_MIX_CHEESE_WHEEL::get, b -> {
    ...
    ACTIVATED_ORANGE_COW_CHEESE_WHEEL = create(CheesyItems.ACTIVATED_ORANGE_COW_CHEESE_WHEEL::get, b -> {
    ...
    BLACK_STRIDER_CHEESE_WHEEL = create(CheesyItems.BLACK_STRIDER_CHEESE_WHEEL::get, b -> {
    ...
    ORANGE_COW_CHEESE_WHEEL = create(CheesyItems.ORANGE_COW_CHEESE_WHEEL::get, b -> {
    ...
    BLUE_SHEEP_CHEESE_WHEEL = create(CheesyItems.BLUE_SHEEP_CHEESE_WHEEL::get, b -> {
    ...
    PASTA_FILATA_BALL = create(CheesyItems.PASTA_FILATA_BALL::get, b -> {
        CheesyHelpers.repeat(12, item -> b.require(item), CheesyItems.PASTA_FILATA.get());
        b.output(CheesyItems.PASTA_FILATA_BALL);
        return b;
    }),

    CREAMY_CHEESE_WHEEL = create(CheesyItems.CREAMY_CHEESE_WHEEL::get, b -> {
